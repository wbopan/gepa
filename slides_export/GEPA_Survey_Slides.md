# GEPA Survey: Prompt Evolution with AdaBoost
...
- P₁ dominates P₂ if: P₁ ≥ P₂ on all samples, strictly better on at least one
...
![Q1 Sampler Comparison](./q1_sampler_comparison.png)
...
![Weight Heatmap](./weight_heatmap_adaboost.png)
...
![Q3 Selector Comparison](./q3_selector_comparison.png)
...
![Q4 Reproducibility](./q4_reproducibility.png)
...
![Q5 Model Comparison](./q5_model_comparison.png)
...
![Q6 Dataset Comparison](./q6_dataset_comparison.png)
...
![Mean Reversion Insight](./mean_reversion_insight.png)
